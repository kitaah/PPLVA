...
<head>
    ...
    <title>Présentation | Prêt pour la vie active</title>
</head>

<body>
    <header>
        <p><a href="index.php?page=accueil"><img src="medias/img/logo_transparent.png" class="logo__img" alt="prêt pour la vie active logo" /></a></p>
    </header>

    <?php require_once $this->presentationPage; ?>
